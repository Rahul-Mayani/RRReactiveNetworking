...
typedef NS_ENUM(NSUInteger, SVProgressHUDAnimationType) {
    ...
    SVProgressHUDAnimationTypeDGActivity // DGActivityIndicatorView
};
...
@property (assign, nonatomic) DGActivityIndicatorAnimationType hUDType UI_APPEARANCE_SELECTOR;
@property (nonatomic, retain) UIColor *tintColor UI_APPEARANCE_SELECTOR; // Assign Tint Color of the Loader (Optional) (Default : White)
@property (nonatomic) CGFloat dimAmount UI_APPEARANCE_SELECTOR; // Assign Dim Amount of HUD (Optional) (Default : 0.7)
